...
const content = {
  zh: {
    ...
    audienceTitle: "",
    audienceText: "：第一優先是活動公司、才藝班、課程品牌、營隊、親子活動、地方創生、社會企業與教育新創；第二優先是有勸募、活動或課程的財團法人與 NGO；第三優先才是小型社團法人或小型協會。。",
    audienceGroups: [
      ["活動公司 / 課程品牌 / 營隊 / 親子活動", "有報名、有收入、有客服、有名單管理需求，最適合從流程系統切入"],
      ["地方創生 / 社會企業 / 教育新創", "常有活動、課程、據點、成果統計與對外服務流程，但系統通常還沒完全成熟"],
      ["財團法人公益組織 / 有活動課程的 NGO", "有預算與正式流程，適合談中型系統，但需要避開已經成熟的既有系統"],
      ["小型社團法人 / 小型協會", "可能有痛點但預算較低，適合小方案或先做流程評估，"],
    ],
