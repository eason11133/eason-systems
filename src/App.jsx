...
const content = {
  zh: {
    ...
    problemTitle: "你的問題通常不是缺一個漂亮頁面，而是流程太分散",
    painPoints: [
      "活動、課程、論壇資訊分散在不同頁面",
    ...
    audienceTitle: "主力服務活動、課程、公益、協會與地方團隊",
    audienceText: "網站目前會優先呈現中型系統能力：活動 / 課程流程、LINE 導覽、資料查詢、後台管理與 Dashboard。小店、個人品牌與夜市攤商只保留為小型入門合作，不再作為主推方向。",
    audienceGroups: [
    ...
    packageTitle: "主力是 5–15 萬級中型系統，小方案只是合作入口",
    packageText: "如果需求包含 LINE Bot、資料查詢、後台管理、據點搜尋、Dashboard、報名 / 服務流程或長期更新，會優先規劃成中型系統案。小方案只保留給需求單純、想先測試合作的客戶，避免主軸被低價小案稀釋。",
