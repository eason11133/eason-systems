...
const content = {
  zh: {
    ...
    rightSmall: "我主要擅長什麼",
    rightTitle: "不是形象網站，而是流程整理型系統",
    rightCards: [
      ["LINE / 網頁資訊入口", "整理課程資訊、活動說明、FAQ、報名連結，讓使用者不用分散查詢。"],
      ["報名與資料整理", "把 Google 表單、名單、報名狀態整理成比較好查詢與管理的資料流程。"],
      ["後台與成果紀錄", "讓內部可以更新資料、查看名單、統計查詢紀錄或整理活動成果。"],
    ],
    miniStats: [["資訊", "集中入口"], ["報名", "資料整理"], ["後台", "管理/成果"]],
    problemLabel: "Problem",
    problemTitle: "如果你們現在是這種狀況，可能適合先聊聊",
    painPoints: [
      "活動資訊分散在官網、社群、LINE、PDF 或表單中",
      "家長或參與者常重複私訊問同樣問題",
      "報名資料靠 Google 表單收，但後續整理、查詢與確認很花時間",
      "LINE 官方帳號目前只是公告，還沒有變成查詢入口",
      "活動後需要整理成果、查詢次數、名單或回饋資料",
      "內部想優化流程，但還不確定第一版系統該做什麼",
    ],
    ...
    buildTitle: "我到底可以幫忙什麼",
    buildText:
      "我主要擅長的不是形象網站，而是流程整理型系統。不是每個案子都要一次做很大，通常會先找出最混亂的一段：資訊入口、報名資料、FAQ 私訊、後台更新或成果紀錄，再做第一版可上線的系統。",
    features: [
      { icon: MapPin, title: "LINE / 網頁資訊入口", text: "整理課程資訊、活動說明、FAQ、報名連結，讓使用者不用分散查詢。" },
      { icon: Database, title: "報名與資料整理", text: "把 Google 表單、名單、報名狀態整理成比較好查詢與管理的資料流程。" },
      { icon: Bot, title: "FAQ 與私訊分流", text: "把常見問題整理成 LINE 或網頁查詢流程，減少重複人工回覆。" },
      { icon: LineChart, title: "後台與成果紀錄", text: "讓內部可以更新資料、查看名單、統計查詢紀錄或整理活動成果。" },
    ],
  ...
  en: {
    ...
    heroTop: "I help event and course teams",
    heroHighlight: "turn scattered work into Web / LINE systems",
    heroText:
      "I help teams turn information scattered across LINE, Google Forms, DMs, and spreadsheets into Web / LINE systems for search, registration, management, and follow-up. This is suitable for teams handling course registration, event information, parent questions, FAQs, participant lists, or outcome records with manual work today.",
    ...
    rightTitle: "Not a branding site, but a workflow system",
    rightCards: [
    ...
    buildLabel: "What I Help With",
    buildTitle: "What I can actually help with",
    buildText:
