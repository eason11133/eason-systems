...
const content = {
  zh: {
    ...
    maintenancePlans: [
      ...
      { name: "主機與系統代管", price: "學生價 NT$ 300–500 / 月起，主機費另計", subtitle: "適合 LINE Bot、後台、Dashboard 或資料庫需要長期穩定運行的專案", items: ["協助 Render / Vercel / 資料庫部署與基本設定", "每月基本上線檢查與環境狀態確認", "小型異常協助判斷與重啟 / 重新部署協助", "主機、資料庫與外部平台費用由實際平台另行收取", "不包含新增功能、大改版或大量資料更新"] },
    ],
