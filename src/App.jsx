...
const content = {
  zh: {
    navContact: "聯絡評估",
    badge: "LINE / Web 前端導覽與流程分流服務",
    heroTop: "我協助活動、課程、營隊與公益團隊",
    heroHighlight: "整理 LINE / Web 前端導覽與流程分流",
    heroText:
      "如果活動資訊、報名連結、FAQ、LINE 詢問、Google 表單、netiCRM 或官網頁面分散在不同地方，我可以協助整理成清楚的入口，讓民眾更快找到正確資訊，也減少同仁重複回覆。簡單來說，既有系統負責資料，我負責入口、導覽與分流。",
    heroButton: "看前端導覽怎麼補強流程",
    stat1Title: "30,000+",
    ...
    rightSmall: "主線服務",
    rightTitle: "不是取代既有系統，而是補入口",
    rightCards: [
      ["LINE 詢問與 FAQ 分流", "把重複問題整理成 LINE / Web 查詢入口，減少同仁一直複製貼上回覆。"],
      ["報名前導覽", "讓民眾先了解活動分類、報名資格、需要準備的資料，再進入表單或既有系統。"],
      ["連結整合與使用紀錄", "把 Google 表單、netiCRM、官網、社群連結整理成入口，也可留下查詢與點擊紀錄。"],
    ],
    miniStats: [["入口", "LINE / Web"], ["分流", "FAQ / 報名前"], ["導回", "既有系統"]],
    problemLabel: "Problem",
    problemTitle: "民眾找不到資訊，同仁一直重複回覆，通常是入口與分流沒有整理好",
    painPoints: [
      "活動資訊分散在官網、社群、LINE、PDF 或表單中",
      "家長、民眾或參與者常重複私訊問同樣問題",
      "報名入口、捐款入口、志工資訊或活動資格藏在不同頁面",
      "LINE 官方帳號目前只是公告，還沒有變成查詢與分流入口",
      "已經有 netiCRM、Google 表單或報名系統，但使用者進去前還是一直問",
      "活動前後資訊、常見問題、查詢紀錄與成果資料仍靠人工整理",
    ],
    ...
    buildLabel: "What I Help With",
    buildTitle: "我能補上的，是既有系統前面的 LINE / Web 導覽層",
    buildText:
      "主線不是重做 CRM，也不是取代 netiCRM、Google 表單或官網，而是先把民眾進入既有系統前的那段流程整理好：活動入口、FAQ 分流、報名前導覽、既有連結整合與使用者查詢紀錄。",
    features: [
    ...
    packageTitle: "主力方案：LINE / Web 前端導覽與流程分流",
    packageText: "如果貴單位已經有 netiCRM、Google 表單、報名系統、捐款系統或官網，我會先看民眾進入這些工具前的入口是否清楚。主力不是重做內部系統，而是補 LINE / Web 導覽、FAQ 分流、報名前引導與既有連結整合。",
    midPlanLabel: "Main Focus",
    midPlanTitle: "常見合作方向：先補入口與分流，不急著重做系統",
    ...
    midPlans: [
      ...
      { name: "簡易後台 / 名單整理工具", price: "NT$ 50,000–120,000 起", subtitle: "適合尚未有既有工具、需要先整理名單或狀態的團隊", items: ["活動名單 / 報名資料整理", "狀態追蹤與日期提醒", "簡易搜尋、篩選與統計", "若已有 netiCRM 或內部系統，優先補前端入口"] },
    ],
    ...
    contactTitle: "你不需要先知道要做什麼系統，只要先告訴我哪一段流程最混亂",
  ...
  en: {
    navContact: "Contact",
    badge: "LINE / Web frontend guidance and workflow routing service",
    heroTop: "I help event, course, camp, and nonprofit teams",
    heroHighlight: "organize LINE / Web guidance and routing",
    heroText:
      "If activity information, registration links, FAQs, LINE inquiries, Google Forms, netiCRM, or official website pages are scattered across different places, I help organize them into a clear entry so people can find the right information faster and staff can reduce repeated replies. Simply put: existing systems handle the data; I handle the entry, guidance, and routing layer.",
    ...
    rightTitle: "Not replacing existing systems — adding the entry layer",
    rightCards: [
    ...
    buildLabel: "What I Help With",
    buildTitle: "I add the LINE / Web guidance layer before existing systems",
    buildText:
    ...
    packageLabel: "Plans & Pricing",
    packageTitle: "Main service: LINE / Web frontend guidance and workflow routing",
    ...
    midPlanLabel: "Main Focus",
    midPlanTitle: "Common directions: start with entry and routing first",
